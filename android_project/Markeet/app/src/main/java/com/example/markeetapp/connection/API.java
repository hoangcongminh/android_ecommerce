package com.example.markeetapp.connection;
...
import com.example.markeetapp.connection.callbacks.CallbackFeaturedNews;
import com.example.markeetapp.connection.callbacks.CallbackInfo;
import com.example.markeetapp.connection.callbacks.CallbackNewsInfo;
import com.example.markeetapp.connection.callbacks.CallbackNewsInfoDetails;
...
import com.example.markeetapp.connection.callbacks.CallbackProductDetails;
...
public interface API {
    ...
    @Headers({CACHE, AGENT})
    @GET("services/listProduct")
    Call<CallbackProduct> getListProductF(
            @Query("count") int count,
            @Query("q") String query
    );
