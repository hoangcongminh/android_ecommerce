...
import com.example.markeetapp.data.AppConfig;
...
public class Tools {
    ...
    public static String getFormattedDate(Long dateTime) {
        SimpleDateFormat newFormat = new SimpleDateFormat("dd MMM, yyyy 'lúc' h:mm a",AppConfig.PRICE_LOCAL_FORMAT);
        return newFormat.format(new Date(dateTime));
    }

    public static String getFormattedDateSimple(Long dateTime) {
        SimpleDateFormat newFormat = new SimpleDateFormat("dd MMM, yyyy",AppConfig.PRICE_LOCAL_FORMAT);
        return newFormat.format(new Date(dateTime));
    }
